...
public class AdminController {
   ...
   public ModelAndView adminClietList(@RequestParam(value = "cPage", required = false, defaultValue = "1") int cPage,
      ...
      mv.addObject("pageBar",
            PageBarFactory.getPageBarWhere2(totalCount2, cPage, numPerPage, "/19AM_dduck_final/dduck/admin/adminClientList.do",keyword));
      mv.addObject("pageBar",
              PageBarFactory.getPageBar(totlaCount, cPage, numPerPage, "/19AM_dduck_final/dduck/admin/adminClientList.do"));
      mv.addObject("count", totlaCount);
   ...
   public ModelAndView adminQnaBoard(@RequestParam(value = "cPage", required = false, defaultValue = "1") int cPage) {
      ...
      mv.addObject("pageBar",
            PageBarFactory.getPageBar(totlaCount, cPage, numPerPage, "/19AM_dduck_final/dduck/admin/adminQnaBoard.do"));
      mv.addObject("count", totlaCount);
   ...
   public ModelAndView paymentList(@RequestParam(value = "cPage", required = false, defaultValue = "0") int cPage) {
      ...
      mv.addObject("pageBar",
            PageBarFactory.getPageBar(totalCount, cPage, numPerPage, "/19AM_dduck_final/dduck/admin/adminmypage.do"));
