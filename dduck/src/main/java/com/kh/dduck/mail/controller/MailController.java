...
//   // 이메일 인증 페이지 맵핑 메소드
      ...
      @RequestMapping("/login/pwChange.do")
  ...
  @RequestMapping(value = "/find_pass.do", method = RequestMethod.POST)
      public ModelAndView find_pass(HttpServletRequest request, String user_id, String e_mail,
          ...
          ModelAndView mv = new ModelAndView();    //ModelAndView로 보낼 페이지를 지정하고, 보낼 값을 지정한다.
          mv.setViewName("/login/emailenroll2");     //뷰의이름
          mv.addObject("dice", dice);
      ...
      @RequestMapping(value = "/pass_injeung.do{dice},{e_mail}", method = RequestMethod.POST)
          public ModelAndView pass_injeung(Client c,String pass_injeung, @PathVariable String dice, 
                  HttpServletResponse response_equals) throws IOException{
          
          System.out.println("마지막  pass_inj:eung : "+pass_injeung);
          System.out.println(c+"11111111111111111111111111111");
          String e_mail=c.getCEmail();
          System.out.println("마지막 : dice : "+dice);
          ModelAndView mv = new ModelAndView();
          
//          mv.setViewName("/login/pwSearch2.do");
          ...
          if (pass_injeung.equals(dice)) {
              ...
              mv.setViewName("login/pwSearch2");
...
//              mv.addObject("e_mail",e_mail);
              ...
              mv2.setViewName("login/emailenroll2");
