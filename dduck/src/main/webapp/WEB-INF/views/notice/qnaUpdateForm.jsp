...
<section id="content">
    <div class="centerset">
		...
		<fieldset>
		    ...
		    <div class="col-md-9">
		        <pre class="list-unstyled"><textarea class="form-control" value="" id="message" name="qaContent" placeholder="내용을 입력해주세요" rows="5" style="height: 500px;" required>${qna.QACONTENT }</textarea></pre>
		    </div>
		    </div>
		    <br>
		    <div class="form-group">
