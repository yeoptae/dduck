<%@page import="com.kh.dduck.client.model.dao.ClientDao"%>
...
<body>
    <%
      /*   String id = session.getAttribute("sessionID").toString();
        ...
        ClientDao c = ClientDao.class();
        MemberBean memberBean = ClientDao.getUserInfo(cId); */
    %>
        ...
        <input class="input100"  name="text" value=${client.CId }>
        <br>
