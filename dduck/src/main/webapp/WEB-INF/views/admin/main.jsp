...
<section class="hero-section">
   <div class="hero-slider owl-carousel">
      <div class="hero-slide-item set-bg"
         data-setbg="${pageContext.request.contextPath }/resources/images/main1.png">
         <div class="hs-text">
            <h2 class="hs-title-1">
               <span>엄마의 손길</span>
            </h2>
      ...
      <div class="hero-slide-item set-bg"
         data-setbg="${pageContext.request.contextPath }/resources/images/main2.png">
         <div class="hs-text">
            <h2 class="hs-title-1">
      ...
      <div class="hero-slide-item set-bg"
         data-setbg="${pageContext.request.contextPath }/resources/images/main3.png">
         <div class="hs-text">
            <h2 class="hs-title-1">
